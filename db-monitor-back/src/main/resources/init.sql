...
CREATE UNIQUE INDEX PROCESSING_PROC_ID_uindex ON PROCESSING (PROC_ID);

CREATE TABLE POSTPROCESSING
(
    POSTPROC_ID VARCHAR(255) PRIMARY KEY NOT NULL,
    POSTPROC_TYPE VARCHAR(255),
    POSTPROC_FORMAT VARCHAR(255),
    POSTPROC_PROC_ID VARCHAR(255) NOT NULL
);
...
(
    ...
    OUTBOUND_STATUS INT,
    OUTBOUND_POSTPROC_ID VARCHAR(255) NOT NULL
);
