...
export class TransactionInfoComponent implements OnInit {
  ...
  initInfo: InitInfo = {
    modelNames: ["Full way", "modelNames2", "modelNames3"],
    environmentNames: ["e2e", "environmentNames2", "environmentNames3"],
  ...
  ngOnInit() {
    ...
    // this.initInfo = {
    //   modelNames: ["modelNames1", "modelNames2", "modelNames3"],
    //   environmentNames: ["environmentNames1", "environmentNames2", "environmentNames3"]
    // }
